...
*/
Vue.component("simple_footer_component_1722039108", {
    template: `
            ...
            <div id="footer-container" class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Explore the latest innovations across industries. Stay ahead of trends and find exciting new products to try.
                    </div>
                </div>
            </div>
        </footer> 
